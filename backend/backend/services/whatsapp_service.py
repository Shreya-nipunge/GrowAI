...
from backend.utils.config_loader import MONGO_URI

from backend.tasks.celery_app import process_message_task
 # Import directly from tasks.py
import logging
...
def send_whatsapp_message(to_number: str, message_text: str) -> dict:
    ...
    access_token = os.getenv("EAAPns20P7vwBPBr16vuZC1aeTLN7ZAW2qwc3a3cYzJqT9PbsC3rWut0fWYCwyCzeNFj8XIS8uYmBFZB6vsZCmpOB4XkRMhQ18CWoxIv7vvtsCtA8CHNhLKJQMYPbiGDnQ8ZAb1H0houReY46gph870JVkkYOWrZAFkUcr7fFZBNmQYZCcmJHD57kJrQRdHPOm4KKYQZDZD")
